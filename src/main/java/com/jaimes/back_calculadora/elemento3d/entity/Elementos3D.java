package com.jaimes.back_calculadora.elemento3d.entity;
...
public class Elementos3D {
    ...
    public Elementos3D(Integer id, String elemento3D, Integer cantidad, Tipo tipo, Medidas3D medidas, Areas areas) {
        this.id = id;
